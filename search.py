...
def pressureSearch(match):
    ...
    superheateddata = shelve.open('/home/manoj/Boiler/super.dat')
...
def _qualityHelper(match):
    ...
    P = match.get('P')
    if P:
        satdata = shelve.open('/home/manoj/Boiler/ptables.dat')
        ...
        satdata = shelve.open('/home/manoj/Boiler/Temptables.dat')
...
def qualitySearch(match):
    ...
    if match.get('P'):
        dummy = 0
        data = shelve.open('/home/manoj/Boiler/ptables.dat')
        property_ = 'pressure'
        value = match.get('P')
        upperValue = 22064.0
        lowerValue = 1.0
        ...
        dummy = 1
        data = shelve.open('/home/manoj/Boiler/Temptables.dat')
        property_ = 'temp'
        value = match.get('T')
        upperValue = 373.95
        lowerValue = 0.01
